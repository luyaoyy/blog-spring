...
public class RedisConfig {
    ...
    @Bean
    @SuppressWarnings("all") //防止装配RedisTemplate<String,Userinfo> redisTemplate时警告
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        RedisTemplate<String, Object> redisTemplate = new RedisTemplate<>();
        redisTemplate.setConnectionFactory(redisConnectionFactory);
        //创建一个json的序列化对象
        GenericJackson2JsonRedisSerializer jackson2JsonRedisSerializer = new GenericJackson2JsonRedisSerializer();//注意用GenericJackson2JsonRedisSerializer
        //设置value的序列化方式json
